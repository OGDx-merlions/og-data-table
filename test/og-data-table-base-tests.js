...
function runBaseTests() {
  og_data_table_1 = document.getElementById('og_data_table_1');

  suite('Base Automation Tests for og-data-table', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('og-data-table fixture is created', function() {
      assert.isTrue(document.getElementById('og_data_table_1') !== null);
    });
